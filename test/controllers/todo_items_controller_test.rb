...
class TodoItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post :create, todo_item: { complete: @todo_item.complete, description: @todo_item.description, due: @todo_item.due, title: @todo_item.title }
    end
  ...
  test "should update todo_item" do
    patch :update, id: @todo_item, todo_item: { complete: @todo_item.complete, description: @todo_item.description, due: @todo_item.due, title: @todo_item.title }
    assert_redirected_to todo_item_path(assigns(:todo_item))
  end
